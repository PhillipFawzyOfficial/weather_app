    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            getColorForWeather(weatherModel!.weatherConsition),
            getColorForWeather(weatherModel!.weatherConsition).withOpacity(0.5),
            getColorForWeather(weatherModel!.weatherConsition).withOpacity(0.1),
          ],
